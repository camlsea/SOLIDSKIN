...
<div class="wrap">
	<div class="layout">
		...
		<tr>
			...
			<c:choose>
		<c:when test="${board.n_writer == u_name}">
				<a class="btn" href="modify.do?n_num=${board.n_num}" title="수정"><strong><img src="../common/images/ico/ico_edit.gif">수정</strong></a>
				<a class="btn" href="delete.do?n_num=${board.n_num}" title="삭제"><strong><img src="../common/images/ico/ico_delete.gif">삭제</strong></a>
				<a class="btn" href="list.do" title="목록"><strong><img src="../common/images/ico/ico_list.gif">목록</strong></a>
		</c:when>
		<c:otherwise>
				<a class="btn" href="list.do" title="목록"><strong><img src="../common/images/ico/ico_list.gif">목록</strong></a>
		</c:otherwise>
	...
	<!-- Input Area -->
		...
		<tr>
			...
			<p>${comment.nc_writer}&nbsp;&nbsp;${comment.nc_date}</p></font>
			<c:if test="${comment.nc_writer == u_name}">
		...
		<tr>
			...
			<td class="content">
				<form action="commentWrite.do" method="post">
					...
					<input type="hidden" id="nc_writer" name="nc_writer" value="${u_name}" /> 
					<input type="hidden" id="linkedArticleNum" name="linkedArticleNum" value="${board.n_num}" />
					<textarea id="nc_content" name="nc_content" class="txt_s" cols="80" rows="3" maxlength="100" onblur="Limit(this)"></textarea>
...
<%-- 	<a href="delete.do?n_num=${board.n_num}">게시글삭제</a>
	<a href="modify.do?n_num=${board.n_num}">수정</a>
