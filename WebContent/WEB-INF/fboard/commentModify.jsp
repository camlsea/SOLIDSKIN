		...
		<tr>
			<td class="writer">				
				...
				<c:if test="${comment.writerId == userId}"> 
					<br /><a onclick="commentDelete(${comment.nc_num}, ${board.n.num})"><small>댓글 삭제</small></a>					
				</c:if>
				</p>
		...
		<tr>
			...
			<td class="content">
				<form action="commentModify.do" method="post">
					...
					<textarea id="fc_content" name="fc_content" class="commentForm">${commentboard.fc_content}</textarea>
